...
const int   mqtt_port   = 1883;const char* mqtt_topic  = "esp32/battery_binhdeptrai";
...
void setup() {
  ...
  setup_wifi();
  #if 0
  Legacy pin sketch disabled because the folder is now built around fall_detection_v2.ino.
  #endif